...
export const sendFinalResponse = (req: Request, res: Response, contentType: string, statusCode: number, sendData: any) => {
  res.setHeader('content-type', contentType);
  return res.status(statusCode).send(sendData);
};

export const sendJsonResponse = (req: Request, res: Response, statusCode: number, data: any, message: string, status: string) => {
  const sendData = { data, message, status };
  sendFinalResponse(req, res, 'application/json', statusCode, sendData);
};

export const sendXmlResponse = (req: Request, res: Response, statusCode: number, data: any, message: string, status: string) => {
...
export const sendTextHtmlResponse = (req: Request, res: Response, statusCode: number, data: any, message: string, status: string) => {
...
export const sendTextResponse = (req: Request, res: Response, statusCode: number, data: any, message: string, status: string) => {
...
export const sendResponse = (req: Request, res: Response, statusCode: number, data: any, message: string, status: string) => {
